 ...
 * do not change the logical primary-key semantics.</p>
 *
 * @since 4.1
 */
public record PrimaryKey(Identifier name, List<Identifier> columns, boolean deferrable,
    ...
    public PrimaryKey(Identifier name, List<Identifier> columns, boolean deferrable, boolean initiallyDeferred) {
