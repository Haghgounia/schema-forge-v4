...
public final class Phase1Application {
    ...
    private static void printUsageAndExit() {
        ...
        System.err.println("  java -jar schema-forge.jar <input.docx> <oracle|postgresql|db2zos>");
        System.err.println("  java -jar schema-forge.jar <input.docx> <output-directory> [oracle|postgresql|db2zos]");
        System.exit(2);
    }
