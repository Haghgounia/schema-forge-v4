...
public final class Phase1Application {
    ...
    private static void printUsageAndExit() {
        ...
        System.err.println("  java -jar schema-forge.jar <input.docx> <oracle|postgresql|db2zos|db2luw|sqlserver|mysql|mariadb>");
        System.err.println("  java -jar schema-forge.jar <input.docx> <output-directory> [oracle|postgresql|db2zos|db2luw|sqlserver|mysql|mariadb]");
        System.exit(2);
    }
